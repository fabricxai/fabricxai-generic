...
export const UI_MESSAGES: Catalogue = {
  en: {
    ...
    'ui.auth.too_many_attempts': 'Too many sign-in attempts. Wait a few minutes and try again.',
    'ui.auth.refused': 'The server refused the sign-in. That is a configuration problem, not your password — the address you are using may not be the one this deployment expects.',
    ...
    // ── orders · the desk, as the Merchandiser Workspace canvas designs it ──
    // The canvas carries a Bangla artboard of this exact screen, which is why every
    // string here has a Bangla twin: identifiers, money and dates stay Latin per the
    // app's typography rule, and everything a person READS turns over.
    'ui.orders.desk_eyebrow': 'Order desk · week of {date}',
    'ui.orders.desk_title': 'Your week',
    'ui.orders.desk_meta_one': '{count} open order',
    'ui.orders.desk_meta_other': '{count} open orders',
    'ui.orders.desk_meta_late': '{count} late',
    'ui.orders.tile_book_value': 'Order book value',
    'ui.orders.tile_shipping': 'Shipping in {month}',
    'ui.orders.tile_shipping_none': 'Shipping',
    'ui.orders.tile_shipping_undated': 'nothing dated yet',
    'ui.orders.tile_at_risk': 'At-risk milestones',
    'ui.orders.tile_at_risk_late': '{count} already late',
    'ui.orders.tile_at_risk_clear': 'none late yet',
    'ui.orders.tile_lc': 'LC conflicts',
    'ui.orders.tile_lc_none_linked': 'no credit is linked to any order yet',
    'ui.orders.tile_lc_clear': 'every credit covers its dates',
    'ui.orders.tile_lc_more': '{names} · and {count} more',
    'ui.orders.ask_marbim': 'Ask MARBIM',
    'ui.orders.ask_slip': 'What slips if fabric lands 3 days late?',
    'ui.orders.ask_update': 'Draft a buyer update',
    'ui.orders.ask_waiting': 'Which orders are waiting on me?',
    'ui.orders.week_title': 'This week',
    'ui.orders.week_eyebrow': 'every milestone on your orders',
    'ui.orders.week_today': 'today',
    'ui.orders.week_nothing_due': 'nothing due',
    'ui.orders.week_empty':
      'Nothing is due on any order this week. Milestones appear here from each order’s time and action plan.',
    'ui.orders.book_title': 'Order book',
    'ui.orders.book_eyebrow': 'every open PO · sorted by ex-factory',
    'ui.orders.col_po': 'PO',
    'ui.orders.col_buyer': 'Buyer',
    'ui.orders.col_style': 'Style',
    'ui.orders.col_qty': 'Qty',
    'ui.orders.col_value': 'Value',
    'ui.orders.col_ex_factory': 'Ex-factory',
    'ui.orders.col_lc': 'LC',
    'ui.orders.col_status': 'Status',
    'ui.orders.lc_none': 'no LC yet',
    'ui.orders.lc_conflict': 'conflict',
    'ui.orders.lc_expired': 'expired {days} d ago',
    'ui.orders.days': '{days} d',
    'ui.orders.days_over': '{days} d over',
    'ui.orders.health_ok': 'on track',
    'ui.orders.health_risk': 'at risk',
    'ui.orders.health_late': 'late',
    'ui.orders.health_done': 'closed',
    'ui.orders.milestone_done': 'done',
    'ui.orders.milestone_planned': 'planned',
...
'ui.drafts.mine_title': 'আমার পাঠানো ড্রাফট',
    ...
    'ui.auth.too_many_attempts': 'অনেকবার সাইন-ইন চেষ্টা হয়েছে। কয়েক মিনিট পরে আবার চেষ্টা করুন।',
    'ui.auth.refused': 'সার্ভার সাইন-ইন ফিরিয়ে দিয়েছে। এটি কনফিগারেশনের সমস্যা, আপনার পাসওয়ার্ডের নয় — আপনি যে ঠিকানা ব্যবহার করছেন সেটি এই ডিপ্লয়মেন্টের প্রত্যাশিত ঠিকানা নাও হতে পারে।',
    ...
    // ── orders ──
    // ── orders · the desk (canvas: "আপনার সপ্তাহ") ──
    'ui.orders.desk_eyebrow': 'অর্ডার ডেস্ক · {date}-এর সপ্তাহ',
    'ui.orders.desk_title': 'আপনার সপ্তাহ',
    'ui.orders.desk_meta_one': '{count}টি চলমান অর্ডার',
    'ui.orders.desk_meta_other': '{count}টি চলমান অর্ডার',
    'ui.orders.desk_meta_late': '{count}টি দেরিতে',
    'ui.orders.tile_book_value': 'অর্ডার বুকের মূল্য',
    'ui.orders.tile_shipping': '{month}-এ শিপমেন্ট',
    'ui.orders.tile_shipping_none': 'শিপমেন্ট',
    'ui.orders.tile_shipping_undated': 'এখনো কোনো তারিখ নেই',
    'ui.orders.tile_at_risk': 'ঝুঁকিতে মাইলফলক',
    'ui.orders.tile_at_risk_late': '{count}টি ইতিমধ্যে দেরিতে',
    'ui.orders.tile_at_risk_clear': 'এখনো কিছু দেরি হয়নি',
    'ui.orders.tile_lc': 'এলসি অসঙ্গতি',
    'ui.orders.tile_lc_none_linked': 'কোনো অর্ডারের সঙ্গে এখনো এলসি যুক্ত নেই',
    'ui.orders.tile_lc_clear': 'প্রতিটি এলসি তার তারিখ কভার করছে',
    'ui.orders.tile_lc_more': '{names} · আরও {count}টি',
    'ui.orders.ask_marbim': 'মারবিমকে জিজ্ঞাসা',
    'ui.orders.ask_slip': 'ফ্যাব্রিক ৩ দিন দেরিতে এলে কী পিছাবে?',
    'ui.orders.ask_update': 'বায়ার আপডেটের খসড়া',
    'ui.orders.ask_waiting': 'কোন অর্ডারগুলো আমার জন্য অপেক্ষা করছে?',
    'ui.orders.week_title': 'এই সপ্তাহ',
    'ui.orders.week_eyebrow': 'আপনার অর্ডারের সব মাইলফলক',
    'ui.orders.week_today': 'আজ',
    'ui.orders.week_nothing_due': 'কিছু বাকি নেই',
    'ui.orders.week_empty':
      'এই সপ্তাহে কোনো অর্ডারে কিছু বাকি নেই। প্রতিটি অর্ডারের টাইম অ্যান্ড অ্যাকশন থেকে মাইলফলক এখানে আসে।',
    'ui.orders.book_title': 'অর্ডার বুক',
    'ui.orders.book_eyebrow': 'সব চলমান পিও · এক্স-ফ্যাক্টরি অনুযায়ী সাজানো',
    'ui.orders.col_po': 'পিও',
    'ui.orders.col_buyer': 'বায়ার',
    'ui.orders.col_style': 'স্টাইল',
    'ui.orders.col_qty': 'পরিমাণ',
    'ui.orders.col_value': 'মূল্য',
    'ui.orders.col_ex_factory': 'এক্স-ফ্যাক্টরি',
    'ui.orders.col_lc': 'এলসি',
    'ui.orders.col_status': 'অবস্থা',
    'ui.orders.lc_none': 'এলসি এখনো নেই',
    'ui.orders.lc_conflict': 'অসঙ্গতি',
    'ui.orders.lc_expired': '{days} দিন আগে মেয়াদ শেষ',
    'ui.orders.days': '{days} দিন',
    'ui.orders.days_over': '{days} দিন পার',
    'ui.orders.health_ok': 'ঠিক পথে',
    'ui.orders.health_risk': 'ঝুঁকি',
    'ui.orders.health_late': 'দেরি',
    'ui.orders.health_done': 'বন্ধ',
    'ui.orders.milestone_done': 'সম্পন্ন',
    'ui.orders.milestone_planned': 'পরিকল্পিত',
